...
result_dir = os.path.join(cwd, 'Results', '03_CC', 'GCAM', '0.0cost_0.0cf')        # result directory
...
for temp_file in temp_files[5:]:                                                            # loop over temperature files
    ...
    cost_file = "Cost_0.00_pect_increase.pkl"                                           # Cost file
    cf_file = "CF_0.00_pect_increase.pkl"                                               # CF file
